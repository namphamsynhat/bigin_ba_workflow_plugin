...
| `{stages_dir}` | `_bigin/stages/` | `extract/` (`2-extraction`, `2b-audit`, `3-filing`), `transform/`, and `design/` — one numbered file per stage. The `design/` guides resolve against `{design_conventions}` § Paths. |
