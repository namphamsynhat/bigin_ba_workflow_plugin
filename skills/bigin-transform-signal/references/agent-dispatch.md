...
2. Update the hub's Signal Log row: Status and Destination per routing.md § Recording the
   routing decision. Never renumber or delete a row.
3. Raise a question only when a decision is genuinely needed (lane-fr.md § Raising a
